...
if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Documents/GitHub/BIOSTS-BMA-BASKET/BMA-SOFTWARE/RESULTS_OPTIMAL";  }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/BMA/RESULTS_OPTIMAL";                                     }
...
name = paste("./K",K0,"-DESIGN-OPTIMAL-",formatC(node.idx, width = 4, format = "d", flag = "0"),".CSV",sep="")
