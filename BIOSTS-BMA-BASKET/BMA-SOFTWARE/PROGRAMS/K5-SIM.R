...
if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Documents/GitHub/BIOSTS-BMA-BASKET/BMA-SOFTWARE/RESULTS";  }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/BMA/RESULTS";                                     }
...
mu0       = c(0.30,0.45);
phi0      = c(0.5,1.00,2.00);
ppEffCrit = seq(0.975,0.990,by=0.0025);
ppFutCrit = seq(0.15,0.40,by=0.025);
pmp.scale = seq(0.00,5.00,by=0.20);
n1        = seq(7,12,1)
n2        = seq(12,17,1)
futOnly   = c(0,1);
