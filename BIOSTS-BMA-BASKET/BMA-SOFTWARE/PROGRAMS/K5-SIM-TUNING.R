...
if (.Platform$OS.type == "windows") { root.path = "C:/Users/psioda/Documents/GitHub/BIOSTS-BMA-BASKET/BMA-SOFTWARE/RESULTS_TUNING";  }
if (.Platform$OS.type == "unix")    { root.path = "/proj/psiodalab/projects/BMA/RESULTS_TUNING";                                                 }
...
name = paste("./K",K0,"-DESIGN-TUNING-",formatC(node.idx, width = 4, format = "d", flag = "0"),".CSV",sep="")
